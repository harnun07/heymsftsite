    ...
    window.CanvasSlideshow = function( options ) {
      ...
      this.initPixi = function() {
        ...
        if ( options.fullScreen === true ) {
          ...
          renderer.view.style.top       = '-280px';
          renderer.view.style.left      = '94%';
          renderer.view.style.webkitTransform = 'translate( -50%, 0% ) scale(1)';
          renderer.view.style.transform = 'translate( -50%, 0% ) scale(1)';
        } else {
